...
namespace sceneEditor.ShaderParams {
    public partial class BoolMatrixArrayShaderParam : BoolMatrixShaderParam {
        public BoolMatrixArrayShaderParam() {
            InitializeComponent();
        }

        public ComboBox ItemIndexList { get { return this.itemIndexList; } }
