...
namespace sceneEditor.ShaderParams {
    public partial class FloatMatrixShaderParam : MatrixShaderParam {
        public FloatMatrixShaderParam() {
            InitializeComponent();
        }
        ...
        public new a3dMatrixShaderParam_Mapper Param {
        ...
        protected override void UpdateMatrixEditorValue(int r, int c, int itemIndex) {
            MatrixEditors[r, c].Minimum = decimal.MinValue;
            MatrixEditors[r, c].Maximum = decimal.MaxValue;
            MatrixEditors[r, c].Value = new decimal(Param.Value.getValue(r, c));
        }
        ...
        protected override void MapMatrixEditorToParam(int row, int col, int itemIndex) {
            ...
            Matrix4_Mapper matrix = Param.Value;
            matrix.setValue(row, col, float.Parse(MatrixEditors[row, col].Value.ToString()));
            Param.Value = matrix;
        }
